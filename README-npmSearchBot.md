...
3. Give the bot a handle (ex: `npmSearchBot`), choose your subscription and resource group
4. For the messaging endpoint, use this: `https://bbe70c1c2651.ngrok.io/api/messages`
