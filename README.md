# Search Based ME - Microsoft Teams App
...
3. Create a new *Web App* with Windows App Service Plan and give it the name of your tab, the same you used when asked for URL in the Yeoman generator. In your case https://bbe70c1c2651.ngrok.io.
...
13. Wait until the deployment is completed and navigate to https://bbe70c1c2651.ngrok.io/privacy.html to test that the web application is running
14. Done
